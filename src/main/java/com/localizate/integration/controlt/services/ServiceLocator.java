...
public class ServiceLocator extends org.apache.axis.client.Service implements com.localizate.integration.controlt.services.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://controlt.net/APP/HUB/service.asmx";
    ...
    public com.localizate.integration.controlt.services.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.localizate.integration.controlt.services.ServiceSoapStub _stub = new com.localizate.integration.controlt.services.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.localizate.integration.controlt.services.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.localizate.integration.controlt.services.ServiceSoapStub _stub = new com.localizate.integration.controlt.services.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://controltrafico.com/", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://controltrafico.com/", "ServiceSoap"));
        }
